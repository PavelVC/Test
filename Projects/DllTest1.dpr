...
begin
  ...
  begin
    LogProc('Задание TFindFilesFrame ' + Data[0] + ' запущено');
    Result := '';
    ...
    LogProc('Задание TFindFilesFrame ' + Data[0] + ' выполнено');
  end;
end;
...
begin
  ...
  begin
    LogProc('Задание FindStringInFile ' + Data[0] + ' запущено');
    Result := '';
    ...
    LogProc('Задание FindStringInFile ' + Data[0] + ' выполнено');
  end;
end;
